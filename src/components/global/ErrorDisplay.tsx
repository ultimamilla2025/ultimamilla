      ...
      >
        ...
        {showDetails && errorMessage && (
          <div className="space-y-3">
            ...
            <div className="bg-[var(--elevated)] border border-[var(--borders)] rounded-lg p-4 overflow-auto">
            ...
            {errorStack && (
              <details className="group">
                <summary className="cursor-pointer text-sm text-[var(--textmuted)] hover:text-[var(--text)] transition-colors">
                  Ver stack trace
                </summary>
                <div className="mt-2 bg-[var(--elevated)] border border-[var(--borders)] rounded-lg p-4 overflow-auto max-h-64">
                  <pre className="text-xs text-[var(--textmuted)] font-mono whitespace-pre-wrap">
                    {errorStack}
                  </pre>
                </div>
              </details>
        ...
        {/* Info adicional */}
        <div className="text-center pt-4 border-t border-[var(--borders)]">
